...
export default function OptimizacionHero() {
  return (
      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-xl border border-white/80 shadow-lg text-sm font-semibold text-slate-700">
            ⚙️ Rendimiento y Core Web Vitals
          </span>
        </motion.div>
        ...
        >
          Haz que tu Web Cargue Rápido y Recupera tus Posiciones en Google.
        </motion.h1>
        ...
        >
          Auditoría y optimización técnica profunda para tu sitio actual. Mejoramos tus métricas de velocidad para retener a tus usuarios y cumplir con las exigentes normativas de los motores de búsqueda.
        </motion.p>
